...
public class DoctorContoller {
    ...
    public static Response createPatient(String id, String username, String firstname, String lastname, String password, String comPassword, String inSpecialty, String license, String office) {
